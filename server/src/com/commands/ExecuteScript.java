...
public class ExecuteScript {
     ...
     * */
    public String execute(CollectionManager manager, String script) throws IOException {
                    ...
                    switch (userMessage[0].trim()){
                        ...
                        case "add":
                            ...
                            if (userMessage[0].trim().equals("add")){
                                response = manager.addES(scanner);
                            }
                            else{
                                response = manager.updateES(Integer.parseInt(userMessage[1]), scanner);
                            }
                            fis.close();
                            if (tmp.delete())
                        ...
                        case "history":
                            ...
                            break;
                        case "remove_by_id":
                            response = manager.removeById(Integer.parseInt(userMessage[1]));
                            break;
